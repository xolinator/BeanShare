...
public sealed class SpaceMappingProfile : IRegister
{
    public void Register(TypeAdapterConfig config)
    {
        config.NewConfig<Space, SpaceDto>()
            ...
            .Map(dest => dest.CreatedBy, src => src.Members.First(m => m.Role == BeanShare.Domain.Enums.SpaceRole.Admin).UserId)
        ...
        config.NewConfig<SpaceMembership, MembershipDto>()
            ...
            .Map(dest => dest.Email, src => "user@example.com") // TODO: Get from user service
