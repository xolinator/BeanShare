...
namespace BeanShare.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260507150533_AddSemiAuthQrDeviceTokens")]
    partial class AddSemiAuthQrDeviceTokens
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BeanShare.Domain.Entities.SemiAuthQrDeviceToken", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("LastUsedQrCodeId")
                        .HasColumnType("uuid");

                    b.Property<Guid?>("LastUsedSpaceId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("SemiAuthQrDeviceTokens", (string)null);
                });
            ...
            modelBuilder.Entity("BeanShare.Domain.Entities.SemiAuthQrDeviceToken", b =>
                {
                    b.HasOne("BeanShare.Domain.Entities.User", null)
                        .WithMany()
